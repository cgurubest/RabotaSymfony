...
class OrderController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $orders = $em->getRepository('RabotaBundle:Order')->findAll();

        return $this->render('order/products.html.twig', array(
            'orders' => $orders,
        ));
    }
    ...
    {
        $order = new Order();
        $form = $this->createForm('RabotaBundle\Form\OrderType', $order);
    ...
    {
        $deleteForm = $this->createDeleteForm($order);
        $editForm = $this->createForm('RabotaBundle\Form\OrderType', $order);
